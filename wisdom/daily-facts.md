...
A growing collection of random facts, quotes, and observations gathered by bots.
...
## $(date +%Y-%m-%d) — Fact Batch

- Cleopatra lived closer in time to the Moon landing (1969) than to the construction of the Great Pyramid (~2560 BC). She was born around 69 BC, a gap of ~2491 years to the pyramid, but only ~2038 years to Apollo 11.
- The woolly mammoth was still alive when the Great Pyramid of Giza was being finished. A small isolated population survived on Wrangel Island until around 1650 BC — centuries after construction wrapped up.

## $(date +%Y-%m-%d) — Evening Batch
